...
switch($error_amount)
{
    case $error_amount:$_SESSION['message'] = 10-$error_amount." tries left.";
}
}
}
...
<div style="background-color:#EFEFEF;position:relative; top:0px; left:0px; border:2px ridge #BBBBBB; width:300px; height:300px; font-family:Times New Roman; font-weight:normal; font-style:normal; text-decoration:none;">
 <form action="" method="post" onsubmit="return true;" autocomplete="off">
  <div id="HangManTitle" style="font-size: 22px; position: absolute; top: 5px; width: 285px; text-align: center;">
   Hangman
  </div>
  <div id="HangManConsole" style="font-size: 16px; position: absolute; top: 34px; text-align: center; width: 284px;">
   Enter a letter: <input type="text" maxlength="1" size="1" id="HangManInput" name="HangManLetter" autofocus /><input type="hidden" value="true" name="send_letter" /><input type="submit" value="Go" name="send_letter_button" /><br /><br />
   The word: <span id="HangManGuessWord" style="letter-spacing:5px;font-weight: bold"><?php echo $_SESSION['guessWord']; ?></span><br />
  </div>
  <div id="HangManImage" style="position: absolute; top: 119px; left: 22px; height: 142px;">
      <img height="150px" width="100px" src="hm<?php echo $_SESSION['error_amount']; ?>.png" id="HangManIMG" />
  </div>
  <div id="HangManMessage" style="font-size: 16px; position: absolute; top: 275px; width: 200px; text-align: center; left: 51px;">
