...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container6").wowSlider({effect:"blast",prev:"",next:"",duration:29*100,delay:36*100,width:960,height:360,autoPlay:true,playPause:true,stopOnHover:false,loop:false,bullets:0,caption:true,captionEffect:"slide",controls:false,onBeforeStep:0,images:0});